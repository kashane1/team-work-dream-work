...
// Employee class which is called by the main index.js and starts the whole application
class Employee {
  constructor () {
...
function buildCards(employees) {
  ...
  // writes the html file and places in /dist folder
  fs.writeFileSync('./dist/index.html', generateHTML(allCards), (err) =>
    err ? console.error(err) : console.log('Success!')
  );
}

// html page function that takes the allCards created from employees array
...
<body>
  <div class="jumbotron jumbotron-fluid">
    <h1 class="display-4 team-title">My Team</h1>
  </div>
  <div class="container">
    <div class="row">
